...
curl -v --header "Content-Type: application/json" --request POST --data '{"sample_type":"blood","sample_ID":"blo123","loc":"f1","status":"ok","Q":4,"unit":"ml","custodian":"charles"}' http://127.0.0.1:5000/sample-log
